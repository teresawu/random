...
import co.uk.room.view.channel.ChannelViewModel
import co.uk.room.view.playlist.PlaylistViewModel
import dagger.Module
import dagger.Provides

@Module
class RoomChannelFragmentModule {

    @Provides
    fun provideChannelViewModel(exceptionTransformers: ExceptionTransformers, schedulerProvider: SchedulerProvider, youtubeApiService: RoomApiService) = ChannelViewModel(exceptionTransformers, schedulerProvider, youtubeApiService)
