...
import co.uk.youtube.BuildConfig
...
object ModelProvider {
    ...
    private fun initYoutubeService(): co.uk.youtube.api.YoutubeApiService = Retrofit.Builder()
            .baseUrl(BuildConfig.YOUTUBE_MAIN)
            .addConverterFactory(GsonConverterFactory.create(gson))
            .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
            .client(okHttpClient)
            .build().create(co.uk.youtube.api.YoutubeApiService::class.java)

    fun getSchedulerProvider() = SchedulerProvider(Schedulers.io(), AndroidSchedulers.mainThread())
    fun getExceptionTransformers() = co.uk.youtube.error.ExceptionTransformers()
}